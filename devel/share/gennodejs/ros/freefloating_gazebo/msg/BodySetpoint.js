...
// (in-package freefloating_gazebo.msg)
...
class BodySetpoint {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new BodySetpoint(null);
  ...
  static messageDefinition() {
    ...
    return `
    # This represents a setpoint in position and velocity in freespace.  
  ...
  static Resolve(msg) {
    ...
    const resolved = new BodySetpoint(null);
